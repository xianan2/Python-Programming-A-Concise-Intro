...
def write_to_file(filename, myname, myage, major):
    outfile = open(filename, 'w')# open file first
...
def name_phone(csv_filename):
    ...
    import csv
    f = open(csv_filename, 'w', newline = '')# open the csv file here
    ...
    while True:
        ...
        phone = input("Enter your friend's phone: ")# add lines here to build a row (that is, a list) and append these
        print(nextname)# two pieces of data to it.  Write to the csv file
        print(phone)
