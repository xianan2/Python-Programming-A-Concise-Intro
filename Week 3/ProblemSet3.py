...
def problem3_1(txtfilename):
    ...
    print()
    print()
    print("There are", char, "letters in the file.")
...
def problem3_3(month, day, year):
    ...
    month_tup = ("January", "February", "March", "April", "May", "June", "July", "August", "Spetempber", "October", "November", "December")
    print(month_tup[int(month)-1], day,end = '')
    print(",", year)
#%%
"""
Problem 3_4:
...
def problem3_4(mon, day, year):
    ...
    month_dict = {"January":1, "February":2, "March":3, "April":4, "May":5, "June":6, "July":7, "August":8, "Spetempber":9, "October":10, "November":11, "December":12}
    date = str(month_dict[mon]) + "/" + str(day) + "/" + str(year)
    print(date)
#%%
"""    
